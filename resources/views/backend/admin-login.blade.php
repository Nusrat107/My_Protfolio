...
<body>
    ...
    <div
        ...
        <div class="w-full rounded-lg bg-slate-900 p-10 text-sm text-indigo-300 sm:w-96 max-w-96 mt-18">
            <h1 class="mb-4 text-center text-3xl font-semibold text-white">Nusrat Jahan</h1>
            <p class="mb-6 text-center text-sm">Welcome Back!</p>
            <form onSubmit=handleEvent(event) action="{{ route('login') }}" method="POST">
              @csrf
                ...
                <div class="mb-5 flex gap-3 rounded-full bg-[#333A5c] px-6 py-3">
                    ...
                    <input type="text" placeholder="Password" name="password" class="border-none outline-none" />
                </div>
            ...
            <p class="mt-4 mb-7 text-center text-sm text-slate-400"><a href="https://codepen.io/Vignesh46/pen/NPWNWEw"
                    target="_blank" class="hover:underline text-blue-400"></a></p>
