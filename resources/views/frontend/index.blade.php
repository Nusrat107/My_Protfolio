...
<!-- Hero Section -->
    <section id="hero" class="hero section dark-background">
      ...
      <img src="{{asset('frontend/assets/img/profile/profile-bg-5.webp')}}" alt="" data-aos="fade-in">
            ...
            <div class="profile-card">
              <div class="profile-header">
                <div class="profile-avatar">
                  <img src="{{asset('frontend/assets/img/profile/profile-square-3.webp')}}" class="img-fluid" alt="">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-creative">
              <div class="portfolio-card">
                <div class="portfolio-image-container">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-1.webp')}}" alt="Creative Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-overlay">
                    ...
                    <div class="portfolio-actions">
                      <a href="{{asset('frontend/assets/img/portfolio/portfolio-1.webp')}}" class="glightbox portfolio-link">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-digital">
              <div class="portfolio-card">
                <div class="portfolio-image-container">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-2.webp')}}" alt="Digital Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-info">
                    ...
                    <div class="portfolio-actions">
                      <a href="{{asset('frontend/assets/img/portfolio/portfolio-2.webp')}}" class="glightbox portfolio-link">
                        <i class="bi bi-plus-lg"></i>
                      </a>
                      <a href="{{url('/portfolio-details')}}" class="portfolio-details">
                        <i class="bi bi-arrow-right"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-strategy">
              <div class="portfolio-card">
                <div class="portfolio-image-container">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-3.webp')}}" alt="Strategy Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-info">
                    ...
                    <div class="portfolio-actions">
                      <a href="{{asset('frontend/assets/img/portfolio/portfolio-3.webp')}}" class="glightbox portfolio-link">
                        <i class="bi bi-plus-lg"></i>
                      </a>
                      <a href="{{url('/portfolio-details')}}" class="portfolio-details">
                        <i class="bi bi-arrow-right"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
              <div class="portfolio-card">
                <div class="portfolio-image-container">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-4.webp')}}" alt="Development Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-info">
                    ...
                    <div class="portfolio-actions">
                      <a href="{{asset('frontend/assets/img/portfolio/portfolio-4.webp')}}" class="glightbox portfolio-link">
                        <i class="bi bi-plus-lg"></i>
                      </a>
                      <a href="{{url('/portfolio-details')}}" class="portfolio-details">
                        <i class="bi bi-arrow-right"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-creative">
              <div class="portfolio-card">
                <div class="portfolio-image-container">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-5.webp')}}" alt="Creative Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-info">
                    ...
                    <div class="portfolio-actions">
                      <a href="{{asset('frontend/assets/img/portfolio/portfolio-5.webp')}}" class="glightbox portfolio-link">
                        <i class="bi bi-plus-lg"></i>
                      </a>
                      <a href="{{url('/portfolio-details')}}" class="portfolio-details">
                        <i class="bi bi-arrow-right"></i>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-digital">
              <div class="portfolio-card">
                <div class="portfolio-image-container">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-6.webp')}}" alt="Digital Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-info">
                    ...
                    <div class="portfolio-actions">
                      <a href="{{asset('frontend/assets/img/portfolio/portfolio-6.webp')}}" class="glightbox portfolio-link">
                        <i class="bi bi-plus-lg"></i>
                      </a>
                      <a href="{{url('/portfolio-details')}}" class="portfolio-details">
                        <i class="bi bi-arrow-right"></i>
